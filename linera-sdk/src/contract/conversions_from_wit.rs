...
impl From<wit_system_api::TimeoutConfig> for TimeoutConfig {
    fn from(guest: wit_system_api::TimeoutConfig) -> TimeoutConfig {
        ...
        TimeoutConfig {
            fast_round_duration: fast_round_duration
                .map(|(secs, nanos)| Duration::new(secs, nanos)),
            base_timeout: Duration::new(base_timeout.0, base_timeout.1),
            timeout_increment: Duration::new(timeout_increment.0, timeout_increment.1),
        }
    }
}
