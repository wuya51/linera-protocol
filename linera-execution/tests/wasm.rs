...
#[cfg_attr(with_wasmer, test_case(WasmRuntime::Wasmer, 74_161, ExecutionRuntimeConfig::Synchronous; "wasmer"))]
#[cfg_attr(with_wasmer, test_case(WasmRuntime::WasmerWithSanitizer, 74_745, ExecutionRuntimeConfig::Synchronous; "wasmer_with_sanitizer"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::Wasmtime, 74_745, ExecutionRuntimeConfig::Synchronous; "wasmtime"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::WasmtimeWithSanitizer, 74_745, ExecutionRuntimeConfig::Synchronous; "wasmtime_with_sanitizer"))]
