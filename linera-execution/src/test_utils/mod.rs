...
pub fn create_dummy_user_application_description(index: u64) -> UserApplicationDescription {
    ...
    let contract_blob_hash = CryptoHash::new(&FakeContractBlob);
    let service_blob_hash = CryptoHash::new(&FakeServiceBlob);
...
pub struct FakeContractBlob;

impl BcsSignable for FakeContractBlob {}

#[derive(Deserialize, Serialize)]
pub struct FakeServiceBlob;

impl BcsSignable for FakeServiceBlob {}
